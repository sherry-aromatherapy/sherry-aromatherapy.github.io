...
<div class="calc-box">
  ...
  <p class="calc-hint">因容量、滴數、濃度不同，實際計算結果可能非整數，實務上也無法滴出小數點的精油滴數，此處已四捨五入為整數滴數，僅供參考。</p>
</div>
...
(function(){
  ...
  function calc(){
    ...
    var drops = oilMl * dpm;
    resultValue.textContent = Math.round(drops) + ' 滴';
  }
...
如果你還不確定不同使用情境該抓多少濃度、哪些精油刺激度較高、部位跟族群怎麼調整，可以參考[《精油濃度安心使用大全》](/eo-dilution-ebook/)，或直接看[精油安全與使用](/archive/safety/)分類裡的文章。
